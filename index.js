...
// 🔧 إعدادات السيرفر
// =======================
const SUPPORT_ROLE_ID = "1455718248493482007";           // رتبة الإدارة/الدعم (صلاحية التحكم)
...
const TYPE_PING_ROLE = {
  support: "1455718248493482007",        // رتبة تنبيه تكت الدعم
  event: "1455718248493482007",          // رتبة تنبيه تكت الفعالية
};
